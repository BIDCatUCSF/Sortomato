function sortomatographpushregiongraph(hObject, ~, hSortomatoGraph, hSortomatoBase, varargin)
    % SORTOMATOGRAPHPUSHREGIONGRAPH Graph objects in the selected region
    ...
    sortomatograph(hObject, [], maskedStruct, hSortomatoBase, rgnGraphString)
end % sortomatographpushregiongraph