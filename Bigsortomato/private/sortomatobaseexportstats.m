function sortomatobaseexportstats(~, ~, xImarisApp, xObject, hSortomatoBase)
    % SORTOMATOEXPORTSTATS Export selected statistics from the Sortomato
