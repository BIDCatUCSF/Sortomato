function graphmanuallimits(~, ~, figSortomatoGraph)
    % GRAPHMANUALLIMITS Toggle manual axes limits
...
function closerequestfcn(guiLimits, ~, hSortomatoGraph)
    % Close sortomato sub-GUIs
    %
    %
    
    %% Remove the GUI handle appdata and delete.
    rmappdata(hSortomatoGraph, 'guiLimits')
    delete(guiLimits);
end % closerequestfcn