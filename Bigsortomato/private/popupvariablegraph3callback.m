function popupvariablegraph3callback(hObject, ~, axesGraph, figSortomatoGraph)
    % POPUPVARIABLEGRAPH3CALLBACK Change a Sortomato graph plotted data
    ...
    set(hScatter, ...
        ...
        'YData', yData, ...
        'ZData', zData)
end % popupvariablegraph3callback