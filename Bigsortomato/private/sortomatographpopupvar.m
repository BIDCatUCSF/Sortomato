function sortomatographpopupvar(hObject, ~, hSortomatoGraph)
    % SORTOMATOGRAPHPOPUPVAR Change a Sortomato graph plotted data
    ...
    toggleContour = findobj(hSortomatoGraph, 'Tag', 'toggleContour');
