function sortomatographpushregioncreate(hObject, ~, hSortomatoGraph)
    % SORTOMATOGRAPHPUSHREGIONCREATE Create an ROI in the SortomatoGraph
...
end % sortomatographpushregioncreate