function sortomatograph(hObject, ~, statStruct, guiSortomato, varargin)
    ...
    addRequired(sortomatographParser, 'hSortomatoBase', @(arg)ishandle(arg))
    ...
    uimenu(menuAxes, ...
        'Callback', {@graphlinearscale, menuAxes, axesGraph}, ...
        'Checked', 'on', ...
        'Label', 'Linear scaling', ...
        'Tag', 'menuAxesLinearScale')
    
    uimenu(menuAxes, ...
        'Callback', {@graphlogscale, menuAxes, axesGraph}, ...
        'Label', 'Log scaling', ...
        'Tag', 'menuAxesLogScale')
    
    uimenu(menuAxes, ...
        'Callback', {@graphlogxscale, menuAxes, axesGraph}, ...
        'Label', 'Log-x scaling', ...
        'Tag', 'menuAxesLogXScale')
    
    uimenu(menuAxes, ...
        'Callback', {@graphlogyscale, menuAxes, axesGraph}, ...
        'Label', 'Log-y scaling', ...
    ...
    uicontrol(figSortomatoGraph, ...
        'BackgroundColor', bColor, ...
        'Callback', {@popupvariablegraphcallback, axesGraph, figSortomatoGraph}, ...
        'FontSize', 12, ...
        'ForegroundColor', fColor, ...
        'Parent', figSortomatoGraph, ...
    ...
    uipushtool(toolbarGraph, ...
        ...
        'Tag', 'pushRegionSort', ...
        'TooltipString', 'Sort the objects inside the selected region into a new Surpass object')
    
    uipushtool(toolbarGraph, ...
        'CData', sortomatographCData.RegionOutsideSort, ...
        'ClickedCallback', {@pushregionsortcallback, figSortomatoGraph, guiSortomato}, ...
        'Tag', 'pushRegionOutsideSort', ...
        'TooltipString', 'Sort the objects outside the selected region into a new Surpass object')
    ...
    uipushtool(toolbarGraph, ...
        ...
        'ClickedCallback', {@graphmanuallimits, figSortomatoGraph}, ...
    ...
    uipushtool(toolbarGraph, ...
        ...
        'ClickedCallback', {@pushhighlightselectioncallback, xObject, axesGraph, figSortomatoGraph}, ...
        'Tag', 'pushSelectionHighlight', ...
        'TooltipString', 'Highlight selected Imaris objects')

    toggleContour = uitoggletool(toolbarGraph, ...
        'CData', sortomatographCData.Contour, ...
        'ClickedCallback', {@togglecontourcallback, axesGraph, figSortomatoGraph}, ...
        'Separator', 'on', ...
        'Tag', 'toggleContour', ...
