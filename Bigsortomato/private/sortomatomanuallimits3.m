function sortomatomanuallimits3(~, ~, hSortomatoGraph)
    % SORTOMATOGRAPHPUSHMANUALLIMITS Toggle manual axes limits
    %   Detailed explanation goes here
    %
    
    %% Check for an existing limit adjustment figure.
    hLimits = getappdata(hSortomatoGraph, 'hLimits');
    ...
    graphPos = get(hSortomatoGraph, 'Position');
    ...
    setappdata(hSortomatoGraph, 'hLimits', hLimits)
...
end % sortomatographpushmanuallimits
...
function closerequestfcn(hObject, ~, hSortomatoGraph)
    ...
    rmappdata(hSortomatoGraph, 'hLimits')
    delete(hObject);
end % closerequestfcn