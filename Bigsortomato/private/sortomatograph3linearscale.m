function sortomatograph3linearscale(~, ~, axesGraph, axesMenu)
    % SORTOMATOGRAPH3LINEARSCALE Set the Sortomato axes to linear scaling
...
end % sortomatograph3linearscale