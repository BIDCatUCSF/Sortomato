function popupvariablegraphcallback(hObject, ~, axesGraph, figSortomatoGraph)
    % POPUPVARIABLEGRAPHCALLBACK Change a Sortomato graph plotted data
...
end % popupvariablegraphcallback