    ...
    switch graphType
        ...
        case 'Singlets'
            ...
            if xFactory.IsSpots(xObject) % Spot sorting
                ...
                sortSpots.Set(xSpotsData.mPositionsXYZ(inIdxs, :), ...
                    xSpotsData.mIndicesT(inIdxs, :), xSpotsData.mRadii(inIdxs, :))
                ...
                for s = 1:length(inIdxs)
                    ...
                    %sNormals = xObject.GetSurfaceNormals(inIdxs(s));
                    sTime = xObject.GetTimeIndex(inIdxs(s));
                    sSurfaceData = xObject.GetSurfaceData(inIdxs(s));
                    %sTriangles = xObject.GetTriangles(inIdxs(s));
                    %sVertices = xObject.GetVertices(inIdxs(s));
