function sortomatostatmath(~, ~, statStruct, hSortomatoBase)
    % SORTOMATOSTATMATH Perform arithmetic on object statistics
    ...
    popupObjects = findobj(hSortomatoBase, 'Tag', 'popupObjects');
    xObject = getappdata(popupObjects, 'xObject');
    
    %% Mask the statistics for track or singlet data.
    panelGraphType = findobj(hSortomatoBase, 'Tag', 'panelGraphType');
    ...
    switch get(radioSelection, 'Tag')
        ...
        case 'radioSinglets'
            ...
            singletStatIdxs = getappdata(hSortomatoBase, 'singletStatIdxs');
        ...
        case 'radioTracks'
            ...
            trackStatIdxs = getappdata(hSortomatoBase, 'trackStatIdxs');
    ...
    uicontrol(...
        ...
        'Style', 'pushbutton', ...
        'Tag', 'pushCalc', ...
        'TooltipString', 'Calculate new statistic');
    ...
    function pushcalc(varargin)
        ...
        [~, statOrder] = sort({statStruct.Name});
        ...
        set(pushStatMath, 'Callback', {@sortomatostatmath, statStruct, hSortomatoBase})
