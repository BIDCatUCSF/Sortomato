function graph3manuallimits(~, ~, figSortomatoGraph)
    % GRAPH3MANUALLIMITS Toggle manual axes limits
...
function closerequestfcn(guiLimits, ~, figSortomatoGraph)
