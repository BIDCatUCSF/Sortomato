function sortomatostatderivatives(hObject, ~, hSortomatoBase)
    % SORTOMATOSTATDERIVATIVES Calculate track statistic derivatives
    ...
    popupObjectsBase = findobj(hSortomatoBase, 'Tag', 'popupObjects');
...
end % sortomatostatderivatives


function pushsurpassrefresh(~, ~, guiStatDerivatives, xImarisApp)
    % SORTOMATOBASESURPASSREFRESH Summary of this function goes here
    %   Detailed explanation goes here
    %
    %   ©2010-2013, P. Beemiller. Licensed under a Creative Commmons Attribution
    %   license. Please see: http://creativecommons.org/licenses/by/3.0/
...
end % sortomatobasesurpassrefresh
