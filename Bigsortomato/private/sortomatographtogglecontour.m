function sortomatographtogglecontour(hObject, ~, hSortomatoGraph, axesGraph)
    % SORTOMATOGRAPHTOGGLECONTOUR Toggle contour plotting of data
    ...
    pushContourSettings = findobj(hSortomatoGraph, 'Tag', 'pushContourSettings');
    ...
    switch lower(get(hObject, 'State'))
            ...
            case 'on'
                ...
                set(pushContourSettings, 'ClickedCallback', ...
                    {@sortomatocontoursettings, hSortomatoGraph, axesGraph})
            ...
            case 'off'
                ...
                if ishandle(hContourSettings)
                    delete(hContourSettings)
...
end % sortomatographtogglecontour