classdef msdanalyzer
    ...
    methods
        ...
        function varargout = plotMeanMSD(obj, ha, errorbar, indices, col)
            ...
            if errorbar
                h = msdanalyzer.errorShade(ha, msmsd(:,1), msmsd(:,2), msmsd(:,3), col, false);
                set(h.mainLine, 'LineWidth', 2);
                
            else
                h = plot(ha, msmsd(:,1), msmsd(:,2), col, ...
                    'LineWidth', 2);
            end
    ...
    methods (Static, Access = private)
        ...
        function H = errorShade(ha, x, y, errBar, col, transparent)
            ...
            %Move the main line over the top of the shaded error patch.
